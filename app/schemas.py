...
class GameBase(BaseModel):
    ...
    ##
    starting_board: Annotated[str, Field(min_length=100, max_length=100, pattern='[~o#<>^v?]{100}')]
    ##
    ...
    ##
    row_nums: Annotated[str, Field(min_length=10, max_length=10, pattern='[0-8]{10}')]
    ##
    ...
    ##
    col_nums: Annotated[str, Field(min_length=10, max_length=10, pattern='[0-8]{10}')]
...
class GameCreate(GameBase):
    ...
    ##
    finished_board: Annotated[str, Field(min_length=100, max_length=100, pattern='[~o#<>^v]{100}')]
